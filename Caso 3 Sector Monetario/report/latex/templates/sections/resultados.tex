...
\textbf{\color{ReportGold}Tabla 6.} Identificación de patrones relevantes del riesgo


\vspace{0.3cm}

\input{../../../tables/table_ques6.tex}
...
\textbf{\color{ReportGold}Figura 6.} Patrones generales identificados en el análisis del riesgo crediticio.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{../../../charts/chart_ques6.png}
\label{fig:patrones_riesgo}
\end{figure}
...
\textbf{\color{ReportGold}Tabla 7} Identificación de patrones relevantes del riesgo


\vspace{0.3cm}

\input{../../../tables/table_ques7.tex}
...
\textbf{\color{ReportGold}Figura 7.} Patrones generales identificados en el análisis del riesgo crediticio.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{../../../charts/chart_ques7.png}
\label{fig:patrones_riesgo}
\end{figure}
